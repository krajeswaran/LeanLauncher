...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private boolean isDragSourceWorkspaceOr(DragObject d) {
        return d.dragSource instanceof Workspace;
    }
    private boolean isWorkspaceOrFolderApplication(DragObject d) {
        return isDragSourceWorkspaceOr(d) && (d.dragInfo instanceof ShortcutInfo);
    }
    private boolean isWorkspaceOrFolderWidget(DragObject d) {
        return isDragSourceWorkspaceOr(d) && (d.dragInfo instanceof LauncherAppWidgetInfo);
    }
    ...
    private void animateToTrashAndCompleteDrop(final DragObject d) {
        ...
        mDeleteDropTargetBar.deferOnDragEnd();
        ...
        Runnable onAnimationEndRunnable = new Runnable() {
            ...
            public void run() {
                completeDrop(d);
                mDeleteDropTargetBar.onDragEnd();
    ...
    public void onFlingToDelete(final DragObject d, int x, int y, PointF vel) {
        ...
        if (mFlingDeleteMode == MODE_FLING_DELETE_TO_TRASH) {
            ...
            mDeleteDropTargetBar.deferOnDragEnd();
            mDeleteDropTargetBar.finishAnimations();
        }
